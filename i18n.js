...
(function () {
  ...
  const TRANSLATIONS = {
    zh: {
      ...
      "sync.create.note": "在另一台设备打开 opendesign.cc → 「我的收藏」→ 「绑定一个同步码」→ 粘进这串。那台设备的收藏会变成这台的。这个码是固定的，不会变，下次再来打开是同一串。",
    ...
    en: {
      ...
      "sync.create.note": "On another device, open opendesign.cc → My Saves → Bind a sync code → paste this. That device's saves will mirror this one's. The code stays the same — open it later, same string.",
