...
(function () {
  ...
  const TRANSLATIONS = {
    "zh-CN": {
      ...
      "library.heading": "每个好网站，变成一份 AI 能读懂的 DESIGN.md。",
      "library.lead": "复制任意条目的 DESIGN.md（11 层设计 Tokens），告诉 Cursor / Claude / v0「照这个做一个页面」，几秒生成同气质 UI —— 不抄品牌资产，只迁移设计语言。",
      "library.num": "第 {n} 号",
    ...
    "zh-TW": {
      ...
      "library.heading": "每個好網站，變成一份 AI 能讀懂的 DESIGN.md。",
      "library.lead": "複製任意條目的 DESIGN.md(11 層設計 Tokens),告訴 Cursor / Claude / v0「照這個做一個頁面」,幾秒生成同氣質 UI —— 不抄品牌資產,只遷移設計語言。",
      "library.num": "第 {n} 號",
      "library.footer.brand": "OpenDesign",
      "library.footer.url": "opendesign.cc",
    ...
    "en": {
      ...
      "library.heading": "Every great site, as a DESIGN.md your AI agent can build from.",
      "library.lead": "Copy any entry's DESIGN.md (11-layer design tokens), tell Cursor / Claude / v0 \"build a page like this\", and get same-spirit UI in seconds — migrating the design language, never the brand assets.",
      "library.num": "No. {n}",
      "library.footer.brand": "OpenDesign",
      "library.footer.url": "opendesign.cc",
    ...
    "ja": {
      ...
      "library.heading": "優れたサイトを、AI が読める DESIGN.md に。",
      "library.lead": "任意の項目の DESIGN.md(11 層デザイントークン)をコピーし、Cursor / Claude / v0 に「これに沿ってページを作って」と伝えれば、数秒で同じ気質の UI が生成されます —— ブランド資産はコピーせず、デザイン言語だけ移植。",
      "library.num": "No. {n}",
      "library.footer.brand": "OpenDesign",
      "library.footer.url": "opendesign.cc",
    ...
    "ko": {
      ...
      "library.heading": "좋은 사이트를, AI 가 읽을 수 있는 DESIGN.md 로.",
      "library.lead": "아무 항목의 DESIGN.md(11 층 디자인 토큰)를 복사해 Cursor / Claude / v0 에 「이대로 페이지를 만들어줘」라고 하면 몇 초 만에 같은 결의 UI 가 생성됩니다 —— 브랜드 자산은 복사하지 않고 디자인 언어만 이식.",
      "library.num": "No. {n}",
      "library.footer.brand": "OpenDesign",
      "library.footer.url": "opendesign.cc",
    ...
    "fr": {
      ...
      "library.heading": "Chaque bon site, en un DESIGN.md que votre agent IA peut suivre.",
    ...
    "es": {
      ...
      "library.heading": "Cada buen sitio, como un DESIGN.md que tu agente IA puede usar.",
    ...
    "ru": {
      ...
      "library.heading": "Каждый хороший сайт — как DESIGN.md, понятный вашему ИИ-агенту.",
